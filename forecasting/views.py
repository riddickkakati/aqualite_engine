        ...
        try:
            ...
            try:
                model = Air2water_OOP(
                    ...
                    validation_required=False if simulation.validation_required == "F" else "Uniform Percentage" if simulation.validation_required == "U" else "Random Percentage" if simulation.validation_required == "R" else "N",
